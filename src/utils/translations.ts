...
export const translations = {
  en: {
    ...
    'account.selectCountry': 'Please choose your country',
    ...
    'address.changeCountryNote': 'To change your country, go to the accounts tab.',
  ...
  ar: {
    ...
    'account.selectCountry': 'يرجى اختيار دولتك',
    ...
    'address.avenue': 'الطريق',
    'address.additionalInfo': 'معلومات إضافية (اختياري)',
    'address.changeCountryNote': 'لتغيير البلد، انتقل إلى تبويب الحساب.',
